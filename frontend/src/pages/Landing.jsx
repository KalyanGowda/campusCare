...
import { ArrowRight, Building2, GraduationCap, LayoutDashboard, ListTodo, Mail, Phone, MapPin, Send, ChevronRight, MessageSquare } from "lucide-react";
...
function HowItWorksSection() {
  ...
  const steps = [
    { num: "1", title: "Spot it", desc: "Notice a broken switch, damaged bench, dirty corridor" },
    { num: "2", title: "Report it", desc: "Select the block, space, and describe the issue" },
    { num: "3", title: "It routes automatically", desc: "Block staff or admin gets notified instantly" },
    { num: "4", title: "Tracked until fixed", desc: "Follow your report's status until it's resolved" },
  ];
  return (
    <div ref={ref} className="max-w-6xl mx-auto">
      <div className="text-center mb-20">
        <h2 className="text-navy font-semibold text-3xl mb-4">How it works</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
        ...
        {steps.map((step, i) => (
          ...
          >
            ...
            <p className="text-ink-muted text-sm leading-relaxed max-w-[220px]">{step.desc}</p>
          </div>
        ))}
      </div>
    </div>
...
function ContactSection() {
  ...
  return (
    <div id="contact" className="bg-navy-deep py-24 px-8 lg:px-24">
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-white font-semibold text-3xl mb-4">Get in Touch</h2>
        ...
        <div
          ref={ref}
          className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 transition-all duration-700 ease-out"
          style={{
            opacity: visible ? 1 : 0,
            transform: visible ? "translateY(0)" : "translateY(32px)",
          }}
        >
          ...
          <div className="flex flex-col gap-8">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">support@bmsit.in</p>
              </div>
            </div>
            <div className="flex items-start gap-4">
              <div className="w-12 h-12 rounded-lg bg-accent/15 flex items-center justify-center shrink-0">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-white/60 text-sm">Mon - Sat, 9:00 AM - 5:00 PM</p>
              </div>
            </div>
          </div>
          ...
          <div
            ref={formRef}
            className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8 transition-all duration-700 ease-out"
            style={{
            ...
            >
              <div className="flex flex-col gap-1.5">
                ...
                <input
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-white/30 outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all"
                />
              </div>
              <div className="flex flex-col gap-1.5">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-white/5 border border-white/10 rounded-lg px-4 py-3 text-white placeholder-white/30 outline-none focus:border-accent focus:ring-1 focus:ring-accent transition-all resize-none"
                />
              </div>
              <button
                type="submit"
                className="w-full bg-accent hover:bg-accent/90 text-navy-deep font-semibold py-3 rounded-lg flex items-center justify-center gap-2 transition-colors"
              >
                Send Message
      ...
      <div className="relative min-h-screen w-full flex flex-col">
        ...
        <header className="w-full z-50 absolute top-0 left-0 right-0 py-6 px-8 lg:px-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <span className="text-white font-semibold tracking-wide text-lg hidden sm:block">CARE</span>
          </div>

          {/* Center Links */}
          <nav className="hidden md:flex items-center gap-10">
            <a href="#about" className="text-white text-sm font-medium hover:text-white/80 transition-colors">About Us</a>
            <a href="#how-it-works" className="text-white text-sm font-medium hover:text-white/80 transition-colors">How it Works</a>
            <a href="#contact" className="text-white text-sm font-medium hover:text-white/80 transition-colors">Contact</a>
          </nav>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-line flex flex-col gap-6 transform transition hover:-translate-y-1 hover:shadow-md">
            ...
            <div className="bg-page-bg p-5 rounded-lg border border-line flex flex-col gap-4 relative overflow-hidden">
              ...
              <div className="bg-white p-3 rounded border border-line flex justify-between items-start shadow-sm">
                <div>
                  <p className="text-xs font-bold text-ink mb-1">Block B, Room 204</p>
                  <p className="text-[11px] text-ink-muted">Fan not working</p>
                </div>
                <span className="bg-warning/20 text-warning px-2 py-0.5 rounded text-[10px] font-medium border border-warning/10">In Progress</span>
              </div>
              <div className="bg-white p-3 rounded border border-line flex justify-between items-start shadow-sm">
                <div>
                ...
                <span className="bg-open-grey/10 text-open-grey px-2 py-0.5 rounded text-[10px] font-medium border border-open-grey/10">Open</span>
              </div>
              <div className="bg-white p-3 rounded border border-line flex justify-between items-start shadow-sm opacity-60">
                ...
                <span className="bg-success/20 text-success px-2 py-0.5 rounded text-[10px] font-medium border border-success/10">Resolved</span>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm border border-line flex flex-col gap-6 transform transition hover:-translate-y-1 hover:shadow-md">
            ...
            <div className="bg-page-bg p-5 rounded-lg border border-line flex flex-col gap-4">
              <div className="flex justify-between items-center mb-1">
                ...
                <span className="text-[10px] bg-navy text-white px-2 py-0.5 rounded">4 Open</span>
              </div>
              {[1, 2, 3].map((i) => (
                <div key={i} className="bg-white p-3 rounded border border-line flex justify-between items-center shadow-sm">
                  <div className="flex-1">
                    <p className="text-xs font-bold text-ink mb-1">Room {200 + i}</p>
                    <p className="text-[11px] text-ink-muted truncate w-[120px]">Electrical issue reported...</p>
                  </div>
                  <div className="flex items-center gap-2">
                    <span className="text-[10px] font-medium text-info bg-info/10 px-1.5 py-0.5 rounded">+4</span>
            ...
            <div className="bg-page-bg p-5 rounded-lg border border-line flex flex-col gap-4">
              ...
              <div className="flex flex-col gap-3">
                {[
                  ...
                  <div key={i} className="bg-white p-3 rounded border border-line flex flex-col gap-2 shadow-sm">
                    <div className="flex justify-between text-xs font-bold">
                      <span>{block.name}</span>
                      <span className={i === 0 ? "text-success" : "text-ink"}>{block.score}</span>
                    </div>
                    <div className="w-full bg-line h-1.5 rounded-full overflow-hidden">
                      <div className="bg-navy h-full rounded-full" style={{ width: block.w }} />
                    </div>
                  </div>
                ))}
              </div>
      ...
      <div className="bg-navy-deep text-white py-16 px-8 lg:px-24">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row justify-between items-center gap-12 md:gap-8">
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm tracking-wide uppercase">Reports resolved within SLA</p>
          </div>
          <div className="hidden md:block w-px h-16 bg-white/20" />
          <div className="text-center">
            <p className="text-4xl font-semibold mb-2">2.4 days</p>
            <p className="text-white/70 text-sm tracking-wide uppercase">Avg. resolution time</p>
          </div>
          <div className="hidden md:block w-px h-16 bg-white/20" />
          <div className="text-center">
            ...
            <p className="text-white/70 text-sm tracking-wide uppercase">Blocks tracked across campus</p>
          </div>
        </div>
      </div>
      ...
      <footer className="bg-white py-12 px-8 lg:px-24 border-t border-line">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row justify-between items-center gap-6">
          <div className="flex items-center gap-4">
            <div className="w-8 h-8 bg-navy text-white font-bold flex items-center justify-center text-sm rounded-sm">C</div>
            <div>
              <p className="font-semibold text-navy">BMSIT&M</p>
              <p className="text-ink-muted text-xs">Campus Infrastructure Complaint System — VTU Project</p>
            </div>
          </div>
